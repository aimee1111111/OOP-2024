...
//colours for green lines 
    ...
    public void draw() {
        ...
        switch (mode) {
            ...
            // Draw a square with 10 vertical sections in a gradient from black to green// only could do it with white 
            int numSquare = 10;
            ...
            case 6: // Pentagon
                ...
                int numSides = 6; // Number of sides in the polygonpw
